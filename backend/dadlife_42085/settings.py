"""
Django settings for dadlife_42085 project.
...
ROOT_URLCONF = 'dadlife_42085.urls'
...
WSGI_APPLICATION = 'dadlife_42085.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dadlife_42085 API",
    "DESCRIPTION": "API documentation for dadlife_42085 App",
    "VERSION": "v1",
}
